...
function Registro() {
  ...
  const RegistroCuenta = async () =>{
    ...
    if(password !== confirmar){
      const msg = "Las contraseñas son distintas"
      swal({
        title: 'Error',
        text: msg,
        icon: 'error',
      ...
      const msg = "La contraseña debe contener mínimo 8 cara tareas"
      swal({
        title: 'Error',
        text: msg,
        icon: 'error',
  ...
  return (
    <div className="hold-transition login-page dark-mode">
      ...
      <div className="login-box">
        ...
        <div className="card bor4 navbar-dark">
          <div className="card-body login-card-body">
            ...
            <form onSubmit={onSubmit}>
              ...
              <div className="social-auth-links text-center mb-3">
                ...
                <Link to = {"/"} className='btn btn-block btn-warning'><b>Regresar a login</b></Link>
              </div>
            </form>
          </div>
        </div>
